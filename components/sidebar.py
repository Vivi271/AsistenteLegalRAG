...
def render_sidebar(vs):
    ...
    <div class="kl-badge">
        <div style="display: flex; align-items: center; justify-content: center; gap: 10px; margin-bottom: 8px;">
            <div style="background: #4a235a; width: 34px; height: 34px; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 1.3rem; color: #ffffff; border: 1px solid rgba(93, 173, 226, 0.4);">K</div>
            <div style="text-align: left; line-height: 1.1;">
                <div style="font-size: 0.9rem; font-weight: 800; color: #ffffff; letter-spacing: 0.5px;">KONRAD</div>
                <div style="font-size: 0.9rem; font-weight: 800; color: #5dade2; letter-spacing: 0.5px;">LORENZ</div>
            </div>
        </div>
        <div style="font-size: 0.62rem; color: #a7f3d0; text-transform: uppercase; letter-spacing: 1px; margin-top: 4px;">Fundación Universitaria</div>
        <div style="margin-top: 8px; padding-top: 8px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
            <div style="font-size: 0.65rem; color: #5dade2; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Acreditación Institucional</div>
            <div style="font-size: 0.62rem; color: #a7f3d0;">de Alta Calidad</div>
        </div>
    </div>
    ...
    if is_admin:
        ...
        k_chunks = st.slider("Fragmentos a recuperar (k)", min_value=3, max_value=8, value=5)
